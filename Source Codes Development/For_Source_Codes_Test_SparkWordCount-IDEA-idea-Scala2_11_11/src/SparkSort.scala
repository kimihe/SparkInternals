...
object SparkSort{
  ...
  def main(args: Array[String]){
    ...
    val sparkConf = new SparkConf().setAppName("ScalaSort")
      ...
      .setJars(List("/Users/zhouqihua/Desktop/For_Source_Codes_Test_SparkWordCount-IDEA-idea-Scala2_11_11/out/artifacts/SparkSort/For_Source_Codes_Test_SparkWordCount-IDEA-idea-Scala2_11_11.jar"))
